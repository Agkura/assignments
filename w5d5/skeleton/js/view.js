...
View.prototype.exercise3 = function () {
  ...
  //your code here!
  const love = $("<h1>i love jquery</h1>");
  $('div').append(love);
};
...
View.prototype.exercise4 = function () {
  ...
  //your code here!
  $('.square').filter(function(index, element){
      return parseInt($(this).data("pos").split(',').slice(-1)[0]) % 2 === 0;
  }).each(function(){
    this.textContent = "MM";
  });
};
...
View.prototype.exercise6 = function () {
  ...
  $('.square').each(function(){
    $(this).attr("style", "background-color : " + window._randomColorString());
  });
};
